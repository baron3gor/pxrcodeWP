...
class PW_CMB2_Field_Select2
{
   ...
   public function setup_admin_scripts()
   {
      ...
      wp_register_script('pw-select2', PXR_CORE_PLUGIN_URL . 'assets/js/select2.min.js', array('jquery-ui-sortable'), '4.0.3');
      wp_enqueue_script('pw-select2-init', PXR_CORE_PLUGIN_URL . 'assets/js/sel2.js', array('cmb2-scripts', 'pw-select2'), self::VERSION);
      wp_register_style('pw-select2', PXR_CORE_PLUGIN_URL . 'assets/css/select2.min.css', array(), '4.0.3');
      wp_enqueue_style('pw-select2-tweaks', PXR_CORE_PLUGIN_URL . 'assets/css/select2.min.css', array('pw-select2'), self::VERSION);
   }
}
